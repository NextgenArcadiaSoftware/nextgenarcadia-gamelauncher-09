          ...
          {step === 'rfid' ? (
            <div className="space-y-8">
              ...
              <div className="flex justify-center">
                <div className="w-32 h-32 flex items-center justify-center bg-orange-500/20 rounded-2xl border-4 border-white/20 backdrop-blur-sm">
            ...
            <div className="space-y-8">
              ...
              <div className="flex justify-center">
                <button onClick={handleFPress} className="w-32 h-32 text-6xl font-bold text-white bg-orange-500 rounded-2xl hover:bg-orange-600 
