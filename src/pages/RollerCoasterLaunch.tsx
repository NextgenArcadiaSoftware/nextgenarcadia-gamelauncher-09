...
export default function RollerCoasterLaunch() {
  ...
  const activeGame = "RollerCoaster Legends";
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-blue-900 to-purple-900">
      ...
      <div className="container mx-auto h-screen flex flex-col items-center justify-center text-white">
        <h1 className="text-5xl font-bold mb-8">RollerCoaster Legends</h1>
        <p className="text-xl mb-12 max-w-2xl text-center">
          Experience the thrill of legendary rollercoasters in virtual reality. 
          From heart-stopping drops to loop-the-loops, feel the rush without leaving your seat!
        </p>
