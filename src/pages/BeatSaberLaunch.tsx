...
export default function BeatSaberLaunch() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-red-900 to-black">
      <Button 
        variant="outline" 
        size="lg"
      ...
      <Button
        variant="default"
        size="lg"
        className="fixed top-8 right-8 z-50 bg-red-600 hover:bg-red-700"
      ...
      <div className="container mx-auto h-screen flex flex-col items-center justify-center text-white">
        <h1 className="text-5xl font-bold mb-8">Beat Saber</h1>
        <p className="text-xl mb-12 max-w-2xl text-center">
          Experience the thrill of slicing blocks to the beat of the music in this immersive rhythm-based VR game.
          Challenge yourself with different difficulty levels and tracks!
        </p>
