        ...
        <div className="glass p-8 rounded-2xl space-y-8 relative overflow-hidden border border-white/20 bg-[#222232]/50 backdrop-blur-xl">
          <div className="text-center">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <span className="inline-block px-4 py-1 rounded-full text-sm text-white/90 bg-purple-500/30 backdrop-blur-sm border border-purple-500/30">
                Cyberpunk
              </span>
