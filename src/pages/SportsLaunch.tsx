    ...
    <div className="fixed inset-0 bg-black flex flex-col items-center justify-center z-50">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute inset-0" style={{
          background: 'linear-gradient(225deg, #22C55E 0%, #059669 100%)',
          opacity: 0.8
        }} />
        <div className="absolute inset-0 mix-blend-overlay opacity-30">
          <img src="/lovable-uploads/sports.png" alt="Sports Background" className="w-full h-full object-cover" />
        </div>
      </div>

      <div className="relative z-10 max-w-4xl w-full mx-auto p-8">
        <div className="glass p-8 rounded-3xl space-y-8 relative overflow-hidden border border-green-500/20">
          ...
          <div className="text-center">
            <p className="text-white/90 text-xl leading-relaxed">
              Experience multiple sports in one amazing VR package! From tennis to basketball, 
              soccer to baseball - enjoy the thrill of sports in virtual reality.
            </p>
          </div>

          <div className="grid grid-cols-3 gap-4 text-center">
            {['Tennis', 'Basketball', 'Soccer'].map((feature, index) => (
              <div key={index} className="p-4 rounded-xl bg-green-500/10 backdrop-blur-sm">
