        ...
        <div className="flex flex-col items-center gap-4">
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-[280px] bg-[#1A1F2C] border border-white/10">
              <DropdownMenuGroup>
                {Object.entries(gameLaunchCodes).map(([game, {
                code,
                description
              }]) => <DropdownMenuItem key={game} className="flex flex-col items-start p-2 focus:bg-white/10 hover:bg-white/5 cursor-pointer">
